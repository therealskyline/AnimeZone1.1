...
@app.route('/api/get-video-url', methods=['POST'])
@login_required
def get_video_url():
    """
    Retourne l'URL directe de la vidéo pour le téléchargement côté client
    """
    try:
        data = request.json
...
def keep_alive():
    while True:
        try:
            ...
            requests.get("https://animezone-pvgs.onrender.com")
